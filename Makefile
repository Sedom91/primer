#############################################################################
# Makefile for building: interface1-2
# Generated by qmake (2.01a) (Qt 4.8.4) on: ?? 15. ??? 17:01:09 2013
# Project:  interface1-2.pro
# Template: app
# Command: c:\Qt\4.8.4\bin\qmake.exe -spec c:\Qt\4.8.4\mkspecs\win32-msvc2005 CONFIG+=release -o Makefile interface1-2.pro
#############################################################################
...
Makefile: interface1-2.pro  c:\Qt\4.8.4\mkspecs\win32-msvc2005\qmake.conf c:\Qt\4.8.4\mkspecs\qconfig.pri \
	...
	$(QMAKE) -spec c:\Qt\4.8.4\mkspecs\win32-msvc2005 CONFIG+=release -o Makefile interface1-2.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) ".\interface1-2.intermediate.manifest"
	-$(DEL_FILE) interface1-2.exp
