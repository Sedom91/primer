...
static const char qt_meta_stringdata_Multichannel[] = {
    "Multichannel\0"
};
...
const QMetaObjectExtraData Multichannel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Multichannel::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Multichannel,
      qt_meta_data_Multichannel, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Multichannel::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Multichannel))
        return static_cast<void*>(const_cast< Multichannel*>(this));
